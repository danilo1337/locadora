...
public class FrmListarTitulo implements Initializable {
	...
	void consultar(ActionEvent event) {
		try {
			...
			Iterator<?> iterator = new PFilmes().listar(filme).iterator();
	...
	public void gerarTabela() {
		String colunas[] = new Filmes().getColunas();
		String nomeVariaveis[] = new Filmes().getVariaveis();
