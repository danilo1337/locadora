...
public class Pilha {
	...
	public void empilhar(Locacao locacao) {
		Pessoal pessoa = null;
	...
	/*
	 * public void empilhar(Locacao locacao, Pessoal pessoa) { No no = new
	 * No(locacao, null, pessoa); no.setProx(topo); topo = no; qtdeElementos++; }
	 */
